export const buttonNotification = {
	successNotific: { variant: 'success', message: 'Login Succesful. Redirecting to GitHub Portal' },
	errorNotific: { variant: 'error', message: 'Invalid UserName. Enter a Valid UserName.' },
	loadingNotific: { variant: 'info', message: 'Fetching User Repositories. Please Be Patient..' },
};

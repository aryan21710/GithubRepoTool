...
export const fetchRepoForNewUser = async (userNameInUrl, enqueueSnackbar, dispatch, history) => {
	...
	if (isValidGitHubUser) {
		enqueueSnackbar(successNotific.message, { variant: successNotific.variant });

 ...
 const Header = props => {
	...
	return (
		<Box className={classes.heading}>
			...
			<Typography variant={headerVariant} gutterBottom={true} className={classes.title}>
				GITHUB REPO TOOL
			</Typography>
			{history.location.pathname !== '/' && <Typography variant="h6" gutterBottom={true} className={classes.username}>
			{uname}
		</Typography>}
		</Box>
	);
